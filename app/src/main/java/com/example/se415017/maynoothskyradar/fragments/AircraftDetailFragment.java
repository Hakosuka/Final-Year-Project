 ...
 * {@link AircraftDetailFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link AircraftDetailFragment#newInstance} factory method to
 * create an instance of this fragment.
 *
 * This Fragment will appear if the user clicks on an item in the AircraftListFragment or long-clicks
 * on an Aircraft icon in the MainMapFragment.
 *
...
public class AircraftDetailFragment extends Fragment {
    ...
    private Aircraft selected; //The Aircraft represented in this Fragment
    ...
    public static AircraftDetailFragment newInstance(String param1, String param2) {
